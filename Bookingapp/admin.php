        ...
        <div class="col">
          <form class="row g-3" method="post" action="/action/add-slot.php">
            <div class="col-auto">
              ...
              <input type="text" name="slotName" class="form-control" id="inputName" placeholder="Name">
            </div>
            <div class="col-auto">
              <label for="inputDescription" class="visually-hidden">Description</label>
              <input type="text" name="slotDescription" class="form-control" id="inputDescription" size="30" placeholder="Description">
            </div>
            <div class="col-auto">
